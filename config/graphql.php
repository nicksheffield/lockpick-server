...
return [
	...
	'schemas' => [
		'default' => [
			'query' => [
				'clients'         => App\GraphQL\Query\ClientQuery::class,
				'logins'          => App\GraphQL\Query\LoginQuery::class,
				'sites'           => App\GraphQL\Query\SiteQuery::class,
			],
			'mutation' => [
				'ClientAdd'       => App\GraphQL\Mutation\ClientAddMutation::class,
				'ClientChange'    => App\GraphQL\Mutation\ClientChangeMutation::class,
				'ClientRemove'    => App\GraphQL\Mutation\ClientRemoveMutation::class,
				'LoginAdd'        => App\GraphQL\Mutation\LoginAddMutation::class,
				'LoginChange'     => App\GraphQL\Mutation\LoginChangeMutation::class,
				'LoginRemove'     => App\GraphQL\Mutation\LoginRemoveMutation::class,
				'SiteAdd'         => App\GraphQL\Mutation\SiteAddMutation::class,
				'SiteChange'      => App\GraphQL\Mutation\SiteChangeMutation::class,
				'SiteRemove'      => App\GraphQL\Mutation\SiteRemoveMutation::class,
			]
		]
	],
	...
	'types' => [
		...
		'Site'           => App\GraphQL\Type\SiteType::class,
	],
